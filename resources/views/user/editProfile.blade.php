        ...
        <div class="col-md-10 col-md-offset-1">
           <div class="panel panel-default">
                <div class="panel-body">  
                    {!! Form::model($items, ['method' => 'PATCH','route' => ['profiledetail.update', $items->id]]) !!}
                        {{ csrf_field() }}
				 ...
				 Field of Interest: 
                  {!! Form::text('interest', null, array('placeholder' => 'Interest','class' => 'form-control')) !!}<br />	
		                ...
		                <div class="controls">
                  More About You : 
                    {!! Form::textarea('about', null, array('placeholder' => 'About','class' => 'tinymce')) !!}</textarea>     
		                </div>
		                </div> 	
